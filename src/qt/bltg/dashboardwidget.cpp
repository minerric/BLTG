    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of BLTG and zBLTG staked."));
    ...
    ui->labelAmountZbltg->setText("0 zBLTG");
    ui->labelAmountBltg->setText("0 BLTG");
    ...
    ui->btnHowTo->setText(tr("How to get BLTG or zBLTG"));
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("BLTG");
    set1 = new QBarSet("zBLTG");
