...
The script [extract-osx-sdk.sh](https://github.com/Block-Logic-Technology-Group/bltg/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bltg/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bltg-project/bltg/blob/master/doc/README_osx.md) for troubleshooting tips.