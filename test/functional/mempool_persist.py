...
By default, bltgd will dump mempool on shutdown and
...
class MempoolPersistTest(BltgTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bltgd from writing mempool.dat to disk. Verify that `savemempool` fails")
