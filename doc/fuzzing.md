...
To build BLTG Core using AFL instrumentation (this assumes that the
...
with certain assembly code from BLTG Core's code. See [developer notes on sanitizers](https://github.com/Block-Logic-Technology-Group/bltg/blob/master/doc/developer-notes.md#sanitizers)
