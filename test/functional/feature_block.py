...
class FullBlockTest(BltgTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bltgd isn't accepting b26
        ...
        # Extend the b28 chain to make sure bltgd isn't accepting b28
        ...
        # BLTG: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the bltg code has custom code which does so);
