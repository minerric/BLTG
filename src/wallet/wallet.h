...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT50000IFMN = 3,
    ONLY_NONDENOMINATED_NOT50000IFMN = 4, // ONLY_NONDENOMINATED and not 50000 BLTG at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZBLTG_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
...
public:
    ...
    std::string GetUniqueWalletBackupName(bool fzbltgAuto) const;
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzBLTGTracker> zbltgTracker;
    ...
    /// Get 50000 BLTG output and keys which can be used for the Masternode
    ...
    /** zBLTG reset */
    boost::signals2::signal<void()> NotifyzBLTGReset;
