...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a BLTG address (e.g. %1)").arg("BPH5YQBXWesDr6R6teorVCmPTtNuitpAMa"));
...
bool openConfigfile()
{
    return openFile(GetConfigFile(gArgs.GetArg("-conf", BLTG_CONF_FILENAME)), true);
}
