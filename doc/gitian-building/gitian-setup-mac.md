...
The build script we'll be using is contained in the BLTG github repository ([contrib/gitian-build.py](https://github.com/Block-Logic-Technology-Group/bltg/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the PIVX repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Block-Logic-Technology-Group/bltg/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, bltg-detached-sigs, and bltg GitHub repos.
