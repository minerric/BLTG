...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"bltg", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bltg", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bltg", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bltg", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bltg", "masternodedebug", &masternodedebug, true, true, false},
        {"bltg", "startmasternode", &startmasternode, true, true, false},
        {"bltg", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bltg", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bltg", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bltg", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bltg", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bltg", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bltg", "preparebudget", &preparebudget, true, true, false},
        {"bltg", "submitbudget", &submitbudget, true, true, false},
        {"bltg", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bltg", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bltg", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bltg", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bltg", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bltg", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bltg", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bltg", "checkbudgets", &checkbudgets, true, true, false},
        {"bltg", "mnsync", &mnsync, true, true, false},
        {"bltg", "spork", &spork, true, true, false},
        {"bltg", "getpoolinfo", &getpoolinfo, true, true, false},
