...
#ifndef BLTG_WALLET_H
#define BLTG_WALLET_H
...
public:
     ...
     * BLTG: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 BLTG output and keys which can be used for the Masternode
