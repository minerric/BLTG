...
class DIP3Test(BltgTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 BLTG) to the operator, and (2 * 2.7 BLTG) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid BLTG address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid BLTG address InvalidPayee", controller.protx_update_registrar,
