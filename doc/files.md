...
bltg.conf           | contains configuration settings for bltgd or bltg-qt
bltgd.pid           | stores the process id of bltgd while running
...
debug.log           | contains debug information and general logging generated by bltgd or bltg-qt
