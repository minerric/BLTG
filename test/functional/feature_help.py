...
"""Verify that starting bltg with -h works as expected."""
...
class HelpTest(BltgTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bltg with -? for help text")
        ...
        self.log.info("Start bltg with -version for version information")
