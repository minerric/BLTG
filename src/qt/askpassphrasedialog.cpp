...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BLTG</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
...
void AskPassphraseDialog::warningMessage()
{
    ...
    openStandardDialog(
            ...
            tr("BLTG will close now to finish the encryption process. "
               ...
               "your BLTGs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
