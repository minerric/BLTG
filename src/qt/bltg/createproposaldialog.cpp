...
#include "qt/bltg/createproposaldialog.h"
#include "qt/bltg/forms/ui_createproposaldialog.h"

#include "qt/bltg/contactsdropdown.h"
#include "qt/bltg/governancemodel.h"
...
CreateProposalDialog::CreateProposalDialog(BLTGGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.bltg/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 BLTG");
