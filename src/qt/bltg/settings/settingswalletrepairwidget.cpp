...
#include "qt/bltg/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bltg/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BLTGGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BLTGGUI::handleRestart()
