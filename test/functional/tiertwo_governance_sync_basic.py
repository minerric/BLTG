...
from test_framework.test_framework import BltgTier2TestFramework
...
class MasternodeGovernanceBasicTest(BltgTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.bltg.org/t/test-proposal",
            2,
