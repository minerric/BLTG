...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://bltg.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/bltg"));
    BOOST_CHECK(validateURL("https://foo.bar/bltg/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.bltg.com"));
